...
namespace Konsolute.Profiles.AppWeb
{
    ...
    public class SharePointAcsContextProvider : SharePointContextProvider
    {
        ...
        {
            return HttpRuntime.Cache[SPContextKey] as SharePointAcsContext;
        }
        ...
        protected override void SaveSharePointContext(SharePointContext spContext, HttpContextBase httpContext)
        {
            ...
            HttpRuntime.Cache[SPContextKey] = spAcsContext;
        }
    }
    ...
    public class SharePointHighTrustContextProvider : SharePointContextProvider
    {
        ...
        protected override SharePointContext LoadSharePointContext(HttpContextBase httpContext)
        {
            return HttpRuntime.Cache[SPContextKey] as SharePointHighTrustContext;
        }

        protected override void SaveSharePointContext(SharePointContext spContext, HttpContextBase httpContext)
        {
            HttpRuntime.Cache[SPContextKey] = spContext as SharePointHighTrustContext;
        }
    }
