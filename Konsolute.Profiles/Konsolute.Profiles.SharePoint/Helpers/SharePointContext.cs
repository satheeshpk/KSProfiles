...
namespace Konsolute.Profiles.SharePoint
{
    ...
    public abstract class SharePointContextProvider
    {
        ...
        public SharePointContext CreateSharePointContext(HttpRequestBase httpRequest)
        {
            ...
            return CreateSharePointContext(
                contextParameters.SPHostUrl,
                contextParameters.SPAppWebUrl,
                contextParameters.SPLanguage, 
                contextParameters.SPClientTag,
                contextParameters.SPProductNumber,
                httpRequest);
        }
    ...
    public class SharePointAcsContextProvider : SharePointContextProvider
    {
        ...
        protected override bool ValidateSharePointContext(SharePointContext spContext, HttpContextBase httpContext)
        {
            ...
            {   
                ...
                Uri spHostUrl = contextParameters.SPHostUrl;
                string contextToken = SharePointContextHelper.GetSharePointContextTokenFromCache();
